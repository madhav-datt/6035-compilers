...
public interface DecafParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DecafParser#extern_decl}.
	 * @param ctx the parse tree
	 */
	void enterExtern_decl(DecafParser.Extern_declContext ctx);
	/**
	 * Exit a parse tree produced by {@link DecafParser#extern_decl}.
	 * @param ctx the parse tree
	 */
	void exitExtern_decl(DecafParser.Extern_declContext ctx);
	/**
